  ...
  return (
    <div className={styles.header}>
      <div className={styles.navleft}>
        ...
        <button className="btn btn-sm btn-ghost">Projects</button>
        <button className="btn btn-sm btn-ghost">Members</button>
      </div>
      ...
      <div className={styles.logo}>
        <button className="btn btn-md btn-ghost">GOSS</button>
      </div>
